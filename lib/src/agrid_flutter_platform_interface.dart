...
import 'agrid_flutter_io.dart';

abstract class AgridFlutterPlatformInterface extends PlatformInterface {
  /// Constructs a AgridFlutterPlatform.
  AgridFlutterPlatformInterface() : super(token: _token);

  static final Object _token = Object();

  static AgridFlutterPlatformInterface _instance = AgridFlutterIO();

  /// The default instance of [AgridFlutterPlatformInterface] to use.
  ///
  /// Defaults to [AgridFlutterIO].
  static AgridFlutterPlatformInterface get instance => _instance;

  /// Platform-specific implementations should set this with their own
  /// platform-specific class that extends [AgridFlutterPlatformInterface] when
  /// they register themselves.
  static set instance(AgridFlutterPlatformInterface instance) {
