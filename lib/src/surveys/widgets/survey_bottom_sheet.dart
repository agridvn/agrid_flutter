...
import '../models/agrid_display_survey.dart';
import '../models/agrid_survey_question_type.dart';
import '../models/survey_appearance.dart';
import '../models/survey_callbacks.dart';
import '../models/agrid_display_link_question.dart';
import '../models/agrid_display_rating_question.dart';
import '../models/agrid_display_choice_question.dart';
import '../models/agrid_display_survey_text_content_type.dart';
...
class SurveyBottomSheet extends StatefulWidget {
  final AgridDisplaySurvey survey;
...
class _SurveyBottomSheetState extends State<SurveyBottomSheet> {
  ...
  Widget _buildQuestion(BuildContext context) {
    ...
    switch (currentQuestion.type) {
      case AgridSurveyQuestionType.openText:
        return OpenTextQuestion(
          ...
          appearance: SurveyAppearance.fromAgrid(widget.survey.appearance),
      ...
      case AgridSurveyQuestionType.link:
        final linkQuestion = currentQuestion as AgridDisplayLinkQuestion;
        return LinkQuestion(
          ...
          onPressed: () async {
            ...
            if (link.isNotEmpty) {
              await AgridFlutterPlatformInterface.instance.openUrl(link);
            }
      ...
      case AgridSurveyQuestionType.rating:
        final ratingQuestion = currentQuestion as AgridDisplayRatingQuestion;
      ...
      case AgridSurveyQuestionType.singleChoice:
      case AgridSurveyQuestionType.multipleChoice:
        final choiceQuestion = currentQuestion as AgridDisplayChoiceQuestion;
        return ChoiceQuestionWidget(
          ...
          isMultipleChoice:
              currentQuestion.type == AgridSurveyQuestionType.multipleChoice,
          onSubmit: (response) async {
                          ...
                          if (!_isCompleted)
                            ...
                            ConfirmationMessage(
                              ...
                              thankYouMessageDescriptionContentType: widget
                                  ...
                                  AgridDisplaySurveyTextContentType.text,
                            ),
                        ],
                      ),
                    ),
