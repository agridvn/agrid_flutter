...
import 'package:agrid_flutter/src/replay/image_extension.dart';
import 'package:agrid_flutter/src/replay/mask/image_mask_painter.dart';
import 'package:agrid_flutter/src/replay/mask/agrid_mask_controller.dart';
import 'package:agrid_flutter/src/replay/native_communicator.dart';
import 'package:agrid_flutter/src/replay/screenshot/snapshot_manager.dart';
import 'package:agrid_flutter/src/replay/size_extension.dart';
import 'package:agrid_flutter/src/replay/vendor/equality.dart';
...
class ScreenshotCapturer {
  ...
  Future<ImageInfo?> captureScreenshot() {
    final context = AgridMaskController.instance.containerKey.currentContext;
    if (context == null) {
    ...
    try {
      ...
      final agridWidgetWrapperElements =
          AgridMaskController.instance.getAgridWidgetWrapperElements();
      ...
      if (replayConfig.maskAllTexts || replayConfig.maskAllImages) {
        elementsDataWidgets =
            AgridMaskController.instance.getCurrentWidgetsElements();
      }

      /// we firstly get current image (syncImage) and masks
      /// (agridWidgetWrapperElements, elementsDataWidgets) synchronously and
      ...
      Future(() async {
        ...
        if (replayConfig.maskAllTexts || replayConfig.maskAllImages) {
          ...
          if (agridWidgetWrapperElements != null &&
              agridWidgetWrapperElements.isNotEmpty) {
            _imageMaskPainter.drawMaskedImageWrapper(
                canvas, agridWidgetWrapperElements, pixelRatio);
          }
