...
1. [Cài đặt](#cài-đặt)
2. [Cấu hình tổng quan](#cấu-hình-tổng-quan)
3. [Android setup](#android-setup)
4. [iOS/macOS setup](#iosmacos-setup)
5. [Web setup](#web-setup)
6. [Khởi tạo trong Dart (manual init)](#khởi-tạo-trong-dart-manual-init)
7. [Gửi sự kiện (capture)](#gửi-sự-kiện-capture)
8. [Xác định người dùng (identify, alias)](#xác-định-người-dùng-identify-alias)
9. [Lấy distinct ID hiện tại](#lấy-distinct-id-hiện-tại)
10. [Sự kiện ẩn danh vs. định danh (personProfiles)](#sự-kiện-ẩn-danh-vs-định-danh-personprofiles)
11. [Super properties](#super-properties)
12. [Group analytics](#group-analytics)
13. [Feature flags](#feature-flags)
14. [Experiments (A/B tests)](#experiments-ab-tests)
15. [Error tracking](#error-tracking)
16. [Session replay](#session-replay)
17. [Surveys](#surveys)
18. [Hành vi offline](#hành-vi-offline)
19. [Opt-out / Opt-in](#opt-out--opt-in)
20. [Debug mode](#debug-mode)
21. [Liên kết tham khảo](#liên-kết-tham-khảo)
...
### 6. Khởi tạo trong Dart (manual init)
...
### 8. Xác định người dùng (identify, alias)
...
### 9. Lấy distinct ID hiện tại

```dart
final id = await Agrid().getDistinctId();
```

### 10. Sự kiện ẩn danh vs. định danh (personProfiles)
