...
class AgridWidget extends StatefulWidget {
  final Widget child;

  const AgridWidget({super.key, required this.child});

  @override
  AgridWidgetState createState() => AgridWidgetState();
}

class AgridWidgetState extends State<AgridWidget> {
  ...
  Widget build(BuildContext context) {
    return RepaintBoundary(
      key: AgridMaskController.instance.containerKey,
      child: Column(
        children: [
